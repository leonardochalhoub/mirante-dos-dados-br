...
%          mapas coropléticos)
% Versão:  2.1 — Abril de 2026 (4 modalidades + benchmark internacional
%          + cross-vertical PBF + 2 mapas coropléticos)
...
\begin{titlepage}
  \begin{center}
    ...
    {\small Versão 2.1 \textemdash{} Abril de 2026}
    ...
    {\small\textsuperscript{2}\,Mirante dos Dados \textemdash{}
     engenharia de dados, análise reproduzível das 4 modalidades,
     benchmark internacional (OCDE/EUA/Japão), análise cross-vertical
     com Bolsa Família, mapas coropléticos por UF.}\\[6pt]
...
Mirante (CNES 2025) e estimativas populacionais IBGE. Escala cividis
...
\par\noindent{\small Fonte: elaboração própria a partir do gold do
Mirante (CNES 2025) e estimativas populacionais IBGE. Densidade =
...
Working Paper n. 4}, v. 2.1, abr.\ 2026. Disponível em:
