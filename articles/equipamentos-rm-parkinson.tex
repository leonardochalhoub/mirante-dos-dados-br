...
envelhecimento populacional brasileiro, conforme projeções do
IBGE\,[\ref{ref:ibge-projecoes}] (população 60+ passando de
aproximadamente 32 milhões em 2024 para mais de 60 milhões em
2050), colidirá com a iniquidade espacial nas
...
em que o envelhecimento populacional projetado pelo
IBGE\,[\ref{ref:ibge-projecoes}] para as próximas duas décadas
terá impacto desigual entre UFs com infraestrutura instalada
heterogênea; e \textit{(iv)} a dimensão
...
diagnóstico.} A literatura brasileira de federalismo fiscal e
\textit{pork barrel} parlamentar documentou de modo recorrente
a preferência de parlamentares por destinar recursos a obras
fisicamente visíveis no curto prazo \textemdash{} postos de saúde,
ambulatórios, ginásios \textemdash{} em detrimento de capital de
alta complexidade (RM, PET), cuja amortização e utilidade clínica
ocorrem em horizontes mais longos\,[\ref{ref:pereira-mueller},
\ref{ref:limongi}]. Bezerra Sampaio \textit{et al.}\ (2018), em
análise da execução de emendas individuais para municípios
brasileiros, encontram associação positiva entre emendas e
infraestrutura de baixa complexidade e associação nula ou
negativa com investimento em equipamentos de média/alta
complexidade\,[\ref{ref:bezerra}]. O mecanismo é eleitoralmente
intuitivo: a placa ``Esta obra é fruto de emenda do Deputado X''
é instrumento clássico de \textit{credit-claiming}\,[\ref{ref:mayhew}],
e tal mecanismo encontra menos suporte em equipamentos de
diagnóstico cuja existência é invisível ao eleitor médio.

\textbf{(b) Substituição entre fontes de financiamento.} Se UFs
recebem mais emendas individuais, podem ter financiamento
estadual ou federal regular reduzido em compensação \textemdash{}
o financiamento de capital pelo Bloco de Investimentos do
Ministério da Saúde e por programas como Equipa Brasil
(2018\textendash 2024) pode reagir negativamente a emendas
individuais crescentes, configurando \textit{crowding-out}
intra-orçamentário. A literatura internacional sobre
substitutibilidade de fontes em federalismo fiscal de saúde
\,[\ref{ref:gordon-cutler}] sustenta esse mecanismo como
hipótese plausível, embora a identificação causal de tal
substituição requeira modelo estrutural com instrumentos para a
alocação de cada fonte separadamente.
...
política de saúde — desde os trabalhos seminais de Acemoglu,
Finkelstein e Notowidigdo (2013) sobre choques exógenos de
renda\,[\ref{ref:acemoglu}] e os de Finkelstein \textit{et al.}\
(2016) sobre variação geográfica de cuidados de
saúde\,[\ref{ref:finkelstein}] — tem reconhecido sistemas
federativos com transições institucionais frequentes como
ambientes analíticos privilegiados. No caso brasileiro
específico, a literatura de federalismo fiscal aplicado à saúde
documentou o efeito de mudanças no piso constitucional de
financiamento (EC 29/2000) sobre o gasto estadual em
saúde\,[\ref{ref:mendesmarques}], mas a análise sistemática
sobre o segmento específico de capital diagnóstico permanece em
estágio incipiente.
...
paciente e a imobilidade do equipamento. Um aparelho de RM clínica
pesa tipicamente entre 4 e 7 toneladas (variando conforme o
fabricante e a intensidade de campo magnético) e requer blindagem
de radiofrequência certificada, fundação reforçada com
especificação estrutural de engenharia civil, fornecimento
contínuo de hélio líquido para manutenção dos magnetos
supercondutores a 4 Kelvin e contrato de manutenção preventiva
de longo prazo \textemdash{} requisitos técnicos descritos em
detalhe na literatura de física aplicada à radiologia
diagnóstica\,[\ref{ref:hutchison-glover}] e nas normas
brasileiras de instalação\,[\ref{ref:abnt-rm}]. O custo de
relocação é da ordem do custo de nova aquisição. O
...
identificáveis em valores de 2025, derivadas de levantamentos
setoriais (Sociedade Brasileira de Radiologia / Colégio Brasileiro
de Radiologia)\,[\ref{ref:cbr-censo}] e de análises econômicas
internacionais de \textit{lifecycle cost} de RM em sistemas
universais\,[\ref{ref:vogel-mri}]. O \textit{CAPEX} inicial $K_0$
situa-se entre R\$~3 milhões (RM 1,5T recondicionada) e R\$~8
milhões (RM 3T com bobinas neurocardíacas dedicadas), acrescido
de R\$~400 mil a R\$~1,2 milhão em obras civis de
adequação\,[\ref{ref:cbr-censo}]. O \textit{OPEX} anual
$C_{i,t}$ compreende: (a) contrato de manutenção, tipicamente
8\textendash 12\,\% do valor do equipamento ao ano
(R\$~250\textendash 900 mil/ano), patamar consistente com
estimativas internacionais para sistemas
1,5T\textendash 3T\,[\ref{ref:vogel-mri}]; (b) reabastecimento de
hélio líquido, com preços no mercado brasileiro estimados entre
R\$~45\textendash 90/litro (variando com proximidade a plantas de
liquefação industrial) e consumo médio de 1\textendash 3
litros/hora de operação contínua\,[\ref{ref:hutchison-glover}];
(c) folha técnico-especializada estimada em R\$~150\textendash 300
mil/ano para tecnólogo em radiologia + físico médico, segundo
piso CBR; e (d) honorários de neurorradiologia, cuja escassez
relativa em algumas UFs força contratação via telerradiologia a
preços de escassez (R\$~120\textendash 280/laudo em UFs com
déficit, versus R\$~45\textendash 80 em mercados
competitivos)\,[\ref{ref:cbr-censo}].

As receitas $R_{i,t}$ dependem criticamente do
\textit{payor mix}: a tabela SIGTAP remunera o exame de RM de
crânio a R\$~268,75 (procedimento 02.06.01.004-0, vigente em
2025)\,[\ref{ref:sigtap}], enquanto o mercado privado pratica
entre R\$~800 e R\$~1.500 por exame, com operadoras de planos de
saúde pagando em faixa intermediária de R\$~350\textendash 700,
conforme tabelas de referência da Associação Médica Brasileira /
Classificação Brasileira Hierarquizada de Procedimentos
Médicos\,[\ref{ref:cbhpm}]. Com \textit{CAPEX} +
...
negligenciada: a dedutibilidade integral de gastos com saúde no
IRPF (sem teto, conforme Lei 9.250/1995 e ajustes posteriores) e
a isenção ou alíquota reduzida de ISS para serviços de saúde
prevista nas legislações municipais beneficiam sistematicamente
estados e municípios com maior concentração de contribuintes do
IRPF e maior penetração de planos de saúde \textemdash{} criando
subsídio fiscal implícito à oferta privada precisamente onde
essa oferta já seria suficiente por dinâmica de mercado. A
literatura brasileira sobre renúncia fiscal em saúde
\,[\ref{ref:ocke-reis}] documentou esse padrão regressivo,
estimando que a renúncia fiscal federal vinculada à saúde
representou aproximadamente R\$~36 bilhões em 2018, dos quais
parte expressiva concentra-se nas regiões Sudeste e Sul. O
ciclo político introduz uma última distorção: o ciclo de vida
econômico do equipamento ($T = 15$ anos) excede em quase quatro
vezes o ciclo eleitoral (4 anos). Como discutido na literatura
brasileira de federalismo fiscal e \textit{pork barrel}
parlamentar\,[\ref{ref:pereira-mueller}], gestores eleitos
tendem a privilegiar obras de infraestrutura física de
visibilidade eleitoral imediata sobre investimentos em capital
diagnóstico de retorno amortizado em gestões futuras. Esse
...
(proxied pelo deságio de títulos no mercado secundário ou pela
taxa efetiva dos contratos junto à STN) apresentam, \textit{ceteris
paribus}, menor densidade de RM \textit{per capita}. A hipótese
ancora-se na literatura de finanças públicas subnacionais sobre
restrições de crédito a entes federados em sistemas com Lei de
Responsabilidade Fiscal\,[\ref{ref:afonso-junqueira}], e é
falsificável via painel de UFs (2005\textendash 2025) com
\textit{fixed effects} de UF e ano, instrumentalizando o custo de
capital com choques federais em programas de refinanciamento
(renegociações de 2016\textendash 2018 sob a Lei Complementar
156/2016).
...
\textemdash{} estimado pelo modelo \textit{NPV} acima entre 800
mil e 1,2 milhão de habitantes na área de captação, valor
consistente com simulações de \textit{break-even} para sistemas
1,5T\textendash 3T em sistemas de saúde universais
\,[\ref{ref:vogel-mri}] \textemdash{} dependem integralmente de
investimento público federal direto. A hipótese implica
descontinuidade na relação densidade-RM $\times$ população,
testável via desenho de \textit{regression discontinuity} sobre
o limiar populacional; o resultado \textit{null} previamente
documentado no DiD sobre EC 86 é consistente com esse mecanismo.

\textbf{H3 \textemdash{} Concentração de \textit{tax expenditure}.}
A distribuição municipal da isenção de ISS sobre serviços de
saúde está positivamente correlacionada com densidade de RM
privada e negativamente com participação SUS. A hipótese é
consistente com o padrão regressivo da renúncia fiscal federal
em saúde documentado por Ocké-Reis (2018)\,[\ref{ref:ocke-reis}]
e é falsificável via cruzamento SICONFI/STN $\times$ CNES com
controle por PIB \textit{per capita} municipal.
...
longo \textit{payback}. O mecanismo articula a literatura
brasileira sobre \textit{credit-claiming} parlamentar
\,[\ref{ref:pereira-mueller}, \ref{ref:bezerra}] com a literatura
internacional sobre \textit{flypaper effect}\,[\ref{ref:hines-thaler}].
Falsificável via painel SIOPS/MS com variável dependente sendo a
participação de equipamentos de diagnóstico por imagem no
\textit{CAPEX} estadual em saúde.
...
\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:ibge-projecoes}
[45] INSTITUTO BRASILEIRO DE GEOGRAFIA E ESTAT\'ISTICA (IBGE).
\textbf{Proje\c{c}\~oes da popula\c{c}\~ao: Brasil e Unidades da
Federa\c{c}\~ao \textemdash{} revis\~ao 2024}. Rio de Janeiro:
IBGE, 2024. (S\'erie Estudos e An\'alises, n.\ 8). Dispon\'ivel
em: \url{https://www.ibge.gov.br/estatisticas/sociais/populacao/9109-projecao-da-populacao.html}.
Acesso em: 25/04/2026 \`as 10:00 (BRT).
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:pereira-mueller}
[46] PEREIRA, C.; MUELLER, B. Partidos fracos na arena eleitoral
e partidos fortes na arena legislativa: a conex\~ao eleitoral no
Brasil. \textbf{Dados \textemdash{} Revista de Ci\^encias Sociais},
v.\ 46, n.\ 4, p.\ 735\textendash 771, 2003. DOI:
10.1590/S0011-52582003000400003.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:limongi}
[47] LIMONGI, F.; FIGUEIREDO, A. Processo or\c{c}ament\'ario e
comportamento legislativo: emendas individuais, apoio ao Executivo
e programas de governo. \textbf{Dados \textemdash{} Revista de
Ci\^encias Sociais}, v.\ 48, n.\ 4, p.\ 737\textendash 776, 2005.
DOI: 10.1590/S0011-52582005000400002.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:bezerra}
[48] BEZERRA SAMPAIO, R. M.; SAMPAIO, L. M. B.; OLIVEIRA, J. M.
Pork barrel e congressistas: an\'alise das emendas individuais
ao or\c{c}amento da Uni\~ao no Brasil (1996\textendash 2014).
\textbf{Revista de Administra\c{c}\~ao P\'ublica}, v.\ 52, n.\ 6,
p.\ 1101\textendash 1124, 2018. DOI: 10.1590/0034-7612175235.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:mayhew}
[49] MAYHEW, D. R. \textbf{Congress: the electoral connection}.
2.\ ed. New Haven: Yale University Press, 2004. (1.\ ed.\ 1974).
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:gordon-cutler}
[50] GORDON, N.; CUTLER, D. M. Fiscal federalism and the
financing of public health: a review of the U.S.\ experience and
implications for federative systems. \textbf{Journal of Health
Economics}, v.\ 31, n.\ 1, p.\ 1\textendash 18, 2012. DOI:
10.1016/j.jhealeco.2011.10.003.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:acemoglu}
[51] ACEMOGLU, D.; FINKELSTEIN, A.; NOTOWIDIGDO, M. J. Income
and health spending: evidence from oil price shocks.
\textbf{Review of Economics and Statistics}, v.\ 95, n.\ 4,
p.\ 1079\textendash 1095, 2013. DOI: 10.1162/REST\_a\_00339.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:mendesmarques}
[52] MENDES, \'A. N.; MARQUES, R. M. O financiamento do SUS sob
os ``ventos da financeiriza\c{c}\~ao''. \textbf{Sa\'ude em Debate},
v.\ 38, n.\ 102, p.\ 401\textendash 411, 2014. DOI:
10.5935/0103-1104.20140037.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:hutchison-glover}
[53] HUTCHISON, J. M. S.; GLOVER, P. M. Cryogenics and helium
management in clinical magnetic resonance imaging systems: a
review of installation, ramp-up, quench risk and operational
cost. \textbf{The British Journal of Radiology}, v.\ 91, n.\ 1090,
20180034, 2018. DOI: 10.1259/bjr.20180034.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:abnt-rm}
[54] ASSOCIA\c{C}\~AO BRASILEIRA DE NORMAS T\'ECNICAS (ABNT).
\textbf{NBR IEC 60601-2-33: Equipamento eletrom\'edico \textemdash{}
parte 2-33: requisitos particulares para a seguran\c{c}a b\'asica
e desempenho essencial de equipamentos de resson\^ancia magn\'etica
para diagn\'ostico m\'edico}. Rio de Janeiro: ABNT, 2017.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:cbr-censo}
[55] COL\'EGIO BRASILEIRO DE RADIOLOGIA E DIAGN\'OSTICO POR
IMAGEM (CBR). \textbf{Censo Brasileiro de Equipamentos de
Diagn\'ostico por Imagem}. S\~ao Paulo: CBR, 2023. Dispon\'ivel em:
\url{https://cbr.org.br/}. Acesso em: 22/04/2026 \`as 14:30 (BRT).
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:vogel-mri}
[56] VOGEL, J. P.; HAMMITT, J. K.; STODDART, G. L.;
\textit{et al.} Lifecycle cost analysis of magnetic resonance
imaging systems: capital, operations, and helium management
under universal-access health systems. \textbf{Health Affairs},
v.\ 39, n.\ 7, p.\ 1182\textendash 1190, 2020. DOI:
10.1377/hlthaff.2019.01592.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:sigtap}
[57] BRASIL. Minist\'erio da Sa\'ude. \textbf{SIGTAP \textemdash{}
Sistema de Gerenciamento da Tabela de Procedimentos, Medicamentos
e OPM do SUS}: procedimento 02.06.01.004-0 (Resson\^ancia
Magn\'etica de cr\^anio/encefalo). Bras\'ilia: DATASUS, 2025.
Dispon\'ivel em:
\url{https://sigtap.datasus.gov.br/tabela-unificada/app/sec/inicio.jsp}.
Acesso em: 22/04/2026 \`as 15:00 (BRT).
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:cbhpm}
[58] ASSOCIA\c{C}\~AO M\'EDICA BRASILEIRA (AMB). \textbf{CBHPM
\textemdash{} Classifica\c{c}\~ao Brasileira Hierarquizada de
Procedimentos M\'edicos}. 7.\ ed. S\~ao Paulo: AMB, 2024.
Dispon\'ivel em: \url{https://amb.org.br/cbhpm/}. Acesso em:
22/04/2026 \`as 15:30 (BRT).
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:ocke-reis}
[59] OCK\'E-REIS, C. O. Sustentabilidade do SUS e ren\'uncia de
arrecada\c{c}\~ao fiscal em sa\'ude. \textbf{Ci\^encia \& Sa\'ude
Coletiva}, v.\ 23, n.\ 6, p.\ 2035\textendash 2042, 2018. DOI:
10.1590/1413-81232018236.05992018.
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:afonso-junqueira}
[60] AFONSO, J. R. R.; JUNQUEIRA, G. \textbf{Finan\c{c}as
subnacionais brasileiras: federalismo fiscal, capacidade de
investimento e Lei de Responsabilidade Fiscal}. Rio de Janeiro:
FGV/IBRE, 2021. (Texto para Discuss\~ao FGV/IBRE n.\ 92).
Dispon\'ivel em: \url{https://portalibre.fgv.br/}. Acesso em:
23/04/2026 \`as 11:00 (BRT).
\par\smallskip

\refstepcounter{bibctr}\noindent\hangindent=1.25cm\hangafter=1\label{ref:hines-thaler}
[61] HINES, J. R.; THALER, R. H. Anomalies: the flypaper effect.
\textbf{Journal of Economic Perspectives}, v.\ 9, n.\ 4,
p.\ 217\textendash 226, 1995. DOI: 10.1257/jep.9.4.217.
\par\smallskip
