...
%          revisão de literatura clínica, recomendações de protocolo)
%          + Leonardo Chalhoub (extensão Mirante — engenharia de dados,
%          análise reproduzível das 4 modalidades, comparação OECD,
%          análise cross-vertical com Bolsa Família)
% Versão:  2.0 — Abril de 2026 (expansão para 4 modalidades + benchmark
%          internacional + cross-vertical PBF; v1.0 era recorte só RM)
...
\begin{titlepage}
  \begin{center}
    ...
    {\small\textsuperscript{1}\,Manuscrito clínico-epidemiológico
     original (v1, abr/2026) \textemdash{} epidemiologia, revisão de
     literatura, síntese de recomendações de protocolo de neuroimagem.}\\[2pt]
    {\small\textsuperscript{2}\,Extensão Mirante \textemdash{} engenharia
     de dados, análise reproduzível das 4 modalidades, benchmark
     internacional (OCDE/EUA/Japão), análise cross-vertical com Bolsa
     Família, expansão CT/PET/Gama Câmara além do recorte RM original.}\\[6pt]
...
Este artigo combina o manuscrito clínico-epidemiológico original de
\textbf{Alexandre Maciel Rolim} (v1, abr/2026) sobre prevalência e
diagnóstico de DP no Brasil com a camada de extensão analítica
desenvolvida na plataforma \textit{Mirante dos Dados} por
\textbf{Leonardo Chalhoub}. O manuscrito de Rolim sustenta as Seções 1
e 2 (introdução clínica e revisão de literatura epidemiológica e
diagnóstica); a extensão Mirante adiciona análise empírica
reproduzível de quatro modalidades de neuroimagem (RM, CT, PET/CT,
Gama Câmara) com 13 figuras vetoriais, comparação internacional
sistemática (OCDE, EUA, Japão, Europa) e análise cross-vertical com a
base Bolsa Família — todas inéditas em relação à v1 do manuscrito.
...
\noindent\hangindent=1.25cm\hangafter=1\label{ref:rolim}
[31] ROLIM, A. M. Análise estatística da prevalência da Doença de
Parkinson no Brasil: desafios, tecnologias de neuroimagem e
perspectivas de políticas públicas. \textbf{Manuscrito v1}, abr.\
2026. (Texto-base deste \textit{Working Paper}, integrado nas seções
de introdução e revisão de literatura.)\par\smallskip
...
ROLIM, A. M.; CHALHOUB, L. Infraestrutura de neuroimagem no SUS
para o diagnóstico diferencial da Doença de Parkinson: Ressonância
Magnética, Tomografia, PET e medicina nuclear (Brasil,
2013\textendash 2025). \textit{Mirante dos Dados \textemdash{}
Working Paper n. 4}, v. 2.0, abr.\ 2026. Disponível em:
