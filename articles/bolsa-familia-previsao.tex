...
a estrutura do sinal piora, não melhora.
...
(estatística de Wald $=0{,}28$), embora a baixa potência de 12 observações
nacionais o torne inconclusivo nos horizontes longos. O teste de
...
primeiro estágio, embora forte, inverte de sinal em relação à janela limpa
\textemdash{} reflexo do choque estrutural de 2020\textendash 2021, que
embaralha a previsão setorial; tratamos a estimativa pontual com a
correspondente cautela. \emph{Segunda}: a exogeneidade do shift-share é uma
...
limitação que séries de backtest mais longas reduziriam.
...
\textbf{Sexta:} a relação emprego$\leftrightarrow$PBF é \emph{causal}, não
apenas associativa. Um instrumento \emph{shift-share} (Bartik) identifica um
efeito 2SLS negativo do emprego formal sobre a cobertura do programa,
significativo na janela completa ($-0{,}63$, $t=-2{,}2$) e maior que o de
MQO \textemdash{} criar emprego formal \emph{retira} famílias da
elegibilidade. E, em previsão, a autorregressão global \emph{bate o arsenal
clássico} (ETS, SARIMA) em todos os horizontes.
