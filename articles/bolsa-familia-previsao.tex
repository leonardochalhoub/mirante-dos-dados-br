...
inferência é feita} \textemdash{} município a município. Numa amostra de 400
municípios, ajustamos um ETS \emph{por município} e o comparamos, nas mesmas
...
limiar de significância no agregado nacional \textemdash{} reflexo direto
das 12 observações \textemdash{}, ao passo que o bootstrap pareado sobre as
\num{66504} previsões municipais (Seção anterior) tem potência ampla. É a
razão de centrarmos a inferência no painel municipal, não no agregado:
$n=12$ não sustenta um teste de série temporal.
...
descrevemos o achado como evidência causal \emph{moderada}, que eleva o
$-0{,}66$ de associação a efeito plausivelmente causal, ainda que o desenho
definitivo \textemdash{} uma descontinuidade de elegibilidade ou um
\emph{event study} de fechamentos de planta via CAGED \textemdash{}
permaneça como agenda (Seção~\ref{sec:extensoes}).
