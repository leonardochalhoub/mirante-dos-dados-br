...
%
% Este Working Paper é um seguimento de DA SILVA & CHALHOUB (2026c,
% Working Paper n. 3, derivado de TATIELI 2022). O escopo aqui é
% deliberadamente diferente: usa-se a cirurgia uroginecológica como
% INDICADOR LIMPO de oferta hospitalar especializada (procedimento
% eletivo, seguro, bem definido em SIGTAP) e cruza-se com agregados
% por UF do Programa Bolsa Família (Mirante WP n. 2) e da execução
% de Emendas Parlamentares (Mirante WP n. 1) para responder uma
% pergunta de federalismo: pobreza estrutural produz desigualdade
% de acesso, e o fluxo fiscal político compensa essa desigualdade?
% =====================================================================
...
\begin{titlepage}
  \begin{center}
    ...
    {\small\textit{Este artigo é o quarto Working Paper do Mirante dos
     ...
     Continua e estende DA SILVA \& CHALHOUB (2026c, Working
     Paper n. 3, derivado de TATIELI 2022).}}
...
descrita em CHALHOUB (2026a, 2026b, 2026c). Em síntese:
...
Paper já refletem essa reconstituição. \textbf{Comparações com
o Working Paper n. 3 ficam prejudicadas em magnitudes
absolutas, mas não nas direções de tendência} \textemdash{} o
que é, por si, um achado metodológico relevante.
...
do paper. As tabelas e correlações apresentadas \textit{não
coincidem} com aquelas publicadas em DA SILVA \& CHALHOUB
(2026c, Working Paper n. 3), pelo motivo descrito na
...
plataforma e as tabelas do Working Paper n. 3 mostravam, sem
qualquer aviso, uma versão \textit{ainda mais desigual} da
realidade do que esta corrigida.
...
Paper n. 6}, abr. 2026f.\par\smallskip
...
\noindent\textbf{Reconhecimento:} este Working Paper é
seguimento de DA SILVA \& CHALHOUB (2026c, Working Paper
n. 3), que por sua vez teve como base o trabalho de
especialização em Enfermagem de TATIELI (2022). A presente
versão reorienta o argumento em torno do cruzamento
