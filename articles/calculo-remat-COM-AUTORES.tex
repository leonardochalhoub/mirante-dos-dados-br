...
\begin{center}
{\large Leonardo Chalhoub\textsuperscript{1} \quad\textbullet\quad
Jefferson Korte Junior\textsuperscript{2} \quad\textbullet\quad
Alexandre Maciel Rolim\textsuperscript{3}}\\[8pt]
\begin{minipage}{0.93\textwidth}\centering\footnotesize
\textsuperscript{1}~Pesquisador independente, Porto Alegre, RS, Brasil.
Mestre em Administração (Finanças), UFRGS.\\
ORCID: [a inserir] \textbullet{} Lattes: \url{http://lattes.cnpq.br/0703595867512327}
\textbullet{} \texttt{leonardochalhoub@gmail.com}\\[3pt]
\textsuperscript{2}~Universidade Tecnológica Federal do Paraná (UTFPR), graduando.\\
ORCID: [a inserir] \textbullet{} Lattes: \url{http://lattes.cnpq.br/6748323429576556}
\textbullet{} \texttt{jefferson.2024@alunos.utfpr.br}\\[3pt]
\textsuperscript{3}~Pesquisador independente, Florianópolis, SC, Brasil.
Mestre em Proteção Radiológica, IFSC.\\
ORCID: [a inserir] \textbullet{} Lattes: \url{http://lattes.cnpq.br/0128707599536129}
\textbullet{} \texttt{alexandremrolim@gmail.com}
\end{minipage}
\end{center}
...
Os autores agradecem a Luis Fernando Kranz (Mestre, Universidade Federal
do Rio Grande do Sul) pelas contribuições à revisão das fontes curriculares
e à discussão do manuscrito.
