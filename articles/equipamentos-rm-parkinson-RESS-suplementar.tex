...
agregados \textemdash{} não leituras diretas do dado bruto. Os totais
nacionais reportados seguem os valores canônicos do corpo do artigo
(calculados sobre a contagem \textit{gold} não arredondada); por isso,
a soma das colunas por unidade federativa pode diferir em uma ou duas
unidades, em razão do arredondamento de cada célula a número inteiro.
Fontes: CNES/DATASUS e estimativas populacionais do IBGE (2024). Código
...
\midrule
\textbf{Brasil} & \textbf{213,4} & \textbf{3.900} & \textbf{18,3} & \textbf{48} & \textbf{8.001} & \textbf{37,5} & \textbf{166} & \textbf{0,8} & \textbf{16.090} & \textbf{75,4} \\
\bottomrule
\end{tabular}
\end{table}
\end{landscape}
