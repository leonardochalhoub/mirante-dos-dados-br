...
CHECKPOINT_LOC = f"/Volumes/{CATALOG}/bronze/raw/_autoloader/bcb_ipca_raw/_checkpoint"
SCHEMA_LOC     = f"/Volumes/{CATALOG}/bronze/raw/_autoloader/bcb_ipca_raw/_schema"
