...
\label{fig:timeline}
\\[-0.2em]\small Fonte: elaboração própria.
\end{figure}
...
\\[-0.2em]\small Fonte: elaboração própria, baseada em Armbrust et al.\ (2021).
\end{figure}
...
\bottomrule
\end{tabular}
\\[0.3em]\small Fonte: elaboração própria, microdados CGU, IPCA-BCB para dez/2021.
\label{tab:evolucao}
\end{table}
...
\label{fig:evolucao}
\\[-0.2em]\small Fonte: elaboração própria, microdados CGU.
\end{figure}
...
\\[-0.2em]\small Fonte: elaboração própria, GeoJSON IBGE + microdados CGU.
\end{figure}
...
\label{fig:choro-cmp}
\\[-0.2em]\small Fonte: elaboração própria. Escala de cores compartilhada.
\end{figure}
...
\label{fig:heatmap}
\\[-0.2em]\small Fonte: elaboração própria. UFs ordenadas em ordem decrescente do per capita 2025.
\end{figure}
...
\label{fig:cv}
\\[-0.2em]\small Fonte: elaboração própria. Linha tracejada: nível típico do Bolsa Família.
\end{figure}
